...
if __name__ == "__main__":
    ...
    img_path = r'/usr/idip/idip/liuan/data/8class_data/img_aug_double_8class_traindata'
    xml_path = r'/usr/idip/idip/liuan/data/8class_data/img_aug_double_8class_traindata_label'
