...
class CSP_Module(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers = [block(self.inplanes_bottle_neck, planes, stride, downsample)] # 这个地方是BottleNeck类
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, layers):
        ...
        self.layer1_org = self._make_layer(block, 64, layers[0])  # 这个block是Bottleneck，utils.py下的一个类
